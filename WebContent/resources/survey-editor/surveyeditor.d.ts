/*Type definitions for Surveyjs Editor JavaScript library v0.12.12
...
export declare class DragDropHelper {
    ...
    constructor(data: Survey.ISurvey, onModifiedCallback: () => any, scrollableElName?: string);
...
export declare class SurveyPropertyEditorShowWindow {
    ...
    constructor();
    show(questionBase: Survey.QuestionBase, onChanged: (question: Survey.QuestionBase) => any): void;
}
...
export declare class SurveyQuestionEditor {
    ...
    koTitle: any;
    onTabClick: any;
    constructor(obj: Survey.Base, onCanShowPropertyCallback: (object: any, property: Survey.JsonObjectProperty) => boolean, className?: string);
    hasError(): boolean;
    reset(): void;
    apply(): void;
}
...
export declare class SurveyQuestionEditorTabProperty extends SurveyQuestionEditorTabBase {
    obj: Survey.Base;
    property: Survey.JsonObjectProperty;
    constructor(obj: Survey.Base, property: Survey.JsonObjectProperty);
    readonly name: string;
    hasError(): boolean;
    readonly htmlTemplate: string;
    readonly templateObject: any;
...
export declare class SurveyObjectProperty {
    ...
    choices: Array<any>;
    constructor(property: Survey.JsonObjectProperty, onPropertyChanged?: SurveyOnPropertyChangedCallback, propertyEditorOptions?: any);
    object: any;
...
export declare class SurveyObjectEditor {
    propertyEditorOptions: any;
    koProperties: any;
    koActiveProperty: any;
    koHasObject: any;
    onPropertyValueChanged: Survey.Event<(sender: SurveyObjectEditor, options: any) => any, any>;
    onCanShowPropertyCallback: (object: any, property: Survey.JsonObjectProperty) => boolean;
    constructor(propertyEditorOptions?: any);
    selectedObject: any;
    setOptions(propertyEditorOptions: any): void;
...
export declare class SurveyEditor {
    ...
    fastCopyQuestion(question: Survey.QuestionBase): void;
}
